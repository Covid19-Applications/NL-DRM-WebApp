		...
		<div class="container box_1170">
			...
			<div class="col-lg-12">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                    <?php
                                                  $query = "SELECT * FROM hospitals  WHERE state = 'nagaland'";
