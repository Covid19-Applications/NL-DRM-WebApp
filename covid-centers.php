        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="bradcam_text">
                        ...
                        <h1>Covid Care Centers</h1>
                            <p>Currently, there is 1 government laboratory approved to test Real-Time (RT-PCR) tests; 12 government laboratories approved to test TrueNat tests for COVID-19 in Nagaland.</p>
                ...
                <div class="col-lg-6">
                    <div class="bradcam_text">
                      <br><br>
                        <a href="https://covid19.nagaland.gov.in/docs/1590648258.pdf"><img src="img/nagaland/banner-3.jpg" class="img-fluid"></a>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="container  text-center">
        ...
        <div class="row col-lg-12">
          ...
          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="https://covidindia.org/Nagaland/">Isolation Centers</a></h4>
          </div>

          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="https://covidindia.org/Nagaland/">Quarantine Centers</a></h4>
          </div>
    ...
    <!-- Start Align Area -->
     ...
     <div class="whole-wrap">
        <div class="container box_1170">
            <div class="col-lg-12">
                     <h2 class="title-1 m-b-25" id="iso" >Covid19 Health Care Centers In Nagaland</h2>
