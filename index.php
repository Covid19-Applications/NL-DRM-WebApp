      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="img/nagaland/map.gif" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            ...
            <ul>
              <li><i class="icofont-check-circled"></i><strong>Formation:</strong> 1 December 1963</li>
              <li><i class="icofont-check-circled"></i><strong>Capital:</strong> Kohima</li>
              <li><i class="icofont-check-circled"></i><strong>Highest elevation (Mount Saramati):</strong> 3,826 m (12,552 ft)</li>
              <li><i class="icofont-check-circled"></i><strong>Population:</strong> 22.8 lakhs (2012)</li>
              <li><i class="icofont-check-circled"></i><strong>Formation:</strong> 1 December 1963</li>
            </ul>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 col-md-6 content-item">
            ...
            <ul>
              <li><a href="https://www.nagaland.gov.in/portal/portal/StatePortal/UsefulLinks/eServices">Online Scholarship Forms Nagaland</a></li>
              <li><a href="https://www.nagaland.gov.in/portal/portal/StatePortal/UsefulLinks/eServices">Birth Certificate</a></li>
              <li><a href="https://www.nagaland.gov.in/portal/portal/StatePortal/UsefulLinks/eServices">Death Certificate</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-4 col-md-6 content-item">
            ...
            <h4>Downloads</h4>
            <ul>
              <li><a href="#">Nagaland CSC</a></li>
              <li><a href="http://finance.nagaland.gov.in/">Budget</a></li>
              <li><a href="https://www.nagaland.gov.in/portal/portal/StatePortal/UsefulLinks/Policies">Policies</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-4 col-md-6 content-item">
            ...
            <h4> Forms</h4>
            <ul>
              <li><a href="https://www.nagaland.gov.in/Nagaland/PAYMENT%20VOUCHER.xls">Payment Voucher</a></li>
              <li><a href="https://www.nagaland.gov.in/Nagaland/Contingent%20bill.xlsx">Contingent Bill</a></li>
              <li><a href="https://www.nagaland.gov.in/Nagaland/Bill%20Extract.doc">Bill Extract</a></li>
            </ul>
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="img/home/govt1.png" class="img-fluid" alt="" style="height: 220px; width: 420px;">
            <div class="portfolio-info">
